---
title: "BIMM-143, Lecture 9"
subtitle: 'Unsupervised Learning Analysis of Human Breast Cancer Cells'
output:
    html_document:
        keep_md: true
        theme: cosmo
...
plot(wisc.pr$x[, ___ ], col = (diagnosis + 1), 
     xlab = "PC1", ylab = "PC3")
